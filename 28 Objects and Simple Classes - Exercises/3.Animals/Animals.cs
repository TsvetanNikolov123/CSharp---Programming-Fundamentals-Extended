namespace _3.Animals
{
    ...
    class Snake
    {
        ...
        public int CrueltyCofficient { get; set; }
    ...
    public class Animals
    {
        public static void Main()
        {
                ...
                if (inputParams.Length > 2)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case "Cat":
                            ...
                            newCat.Name = name;
                            newCat.Age = age;
                            newCat.IntelligenceQuontient = parameter;
                        ...
                        case "Snake":
                            ...
                            newSnake.Name = name;
                            newSnake.Age = age;
                            newSnake.CrueltyCofficient = parameter;
            ...
            {
                Console.WriteLine("Cat: {0}, Age: {1}, IQ: {2}", cat.Name, cat.Age, cat.IntelligenceQuontient);
            }

            foreach (var snake in snakes.Values)
            {
                Console.WriteLine("Snake: {0}, Age: {1}, Cruelty: {2}", snake.Name, snake.Age, snake.CrueltyCofficient);
            }
        }
    }
}
